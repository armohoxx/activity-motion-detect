...
protocol OldLocationHelperDelegate {
    func onLocationUpdated(location: Location)
    func onLocationUpdateFailed(error: Error)
}

class OldLocationHelper : NSObject {
    
    public var delegate: OldLocationHelperDelegate?
    ...
    private static var instance: OldLocationHelper = {
        let instance = OldLocationHelper()
    ...
    public static func shared() -> OldLocationHelper {
        return instance
    }
...
extension OldLocationHelper : CLLocationManagerDelegate {
